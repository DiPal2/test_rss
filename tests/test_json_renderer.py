...
@pytest.mark.parametrize(
    "data,expected",
    [
        pytest.param({"other": "other"}, dict(), id="empty"),
        pytest.param({"title": "test"}, {"title": "test"}, id="exact"),
        pytest.param({"title": "test", "other": "other"}, {"title": "test"}, id="reduced"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param({"title": "test", "other": "other"}, {"title": "test"}, id="title_reduced"),
        pytest.param({"published": "2020-01-02"}, {"published": "2020-01-02"}, id="published"),
        pytest.param({"link": "http:\\one.com"}, {"link": "http:\\one.com"}, id="link"),
        pytest.param({"description": "Test news"}, {"description": "Test news"}, id="description"),
        pytest.param({"title": "test", "published": "2020-01-02", "link": "http:\\one.com", "description": "Test news"}, {"title": "test", "published": "2020-01-02", "link": "http:\\one.com", "description": "Test news"}, id="all"),
    ],
)
